...
const manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["android-chrome-192x192.png", "android-chrome-512x512.png", "favicon-16x16.png", "favicon.ico", "favicon.png", "robots.txt", "smui.css"]),
  ...
  _: {
    ...
    routes: [
      ...
      },
      {
        ...
        types: [],
        path: "/schedule",
        shadow: () => Promise.resolve().then(() => __toESM(require("./entries/endpoints/schedule.ts.js"))),
        a: [0, 4],
        b: [1]
      }
    ],
